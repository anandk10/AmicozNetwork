	...
	<div id="wrapper">
		<div id="userbar">
			...
			<div id="userinformation">
				...
				<div>
					<p id="profile_information">${profile_information}</p>
				</div>
...
$.each(posts,function(index,data){
	...
	var userInfo = '<div class="userinfo"><img src="'+data.profilePicURL+'" class="profilepic" /> <span class="username"><a href="profile/'+data.userId+'">'+data.userName+'</a></span><br/><span class="datetime">'+data.time+'</span><br/></div>';
	
	var postContent = '<div class="post">'+data.postText+'</div>';
	
	var likesDislikes = '<div class="likebar"><a href="#likes">'+data.likeCount+'<img src="imgs/like.png"/ class="like"></a><a href="#dislikes">'+data.dislikeCount+'<img src="imgs/dislike.png"/ class="like"></a></div>';
					        ...
					        alert("Your comment cannot exceed 250 characters!");
					    	  ...
					    	  $.ajax({
								...
								success: function(data3){
									...
									if(data3==1){
										$("#comments"+data.postID).append('<li><img src="" class="friendcommentpic" /> <span class="username"><a href="profile/'+data.userId+'">'+data.userName+'</a></span><div class="usercomment">' + comment + '</div></li>');
									}else{
										console.log("in else");
