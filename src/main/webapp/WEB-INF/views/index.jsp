...
/* 	if(posts.length == 0)
		...
		$.each(posts, function(index, data) {
						...
						var userInfo = '<div class="userinfo"><img src="'+data.profilePicURL+'" class="profilepic" /> <span class="username"><a href="profile/'+data.userId+'">'
								+ data.userName
						...
						var likesDislikes = '<div class="likebar"><input id = "likeButton" type = "image" src="imgs/like.png"><a href="#dislikes">'
								+ data.dislikeCount
