		...
		try{
			...
			if(list != null){
				...
				if(list.get(0).getDateOfBirth() != null)
					retVal.add(list.get(0).getDateOfBirth().toString());
				else
					retVal.add("");
				...
				if(list.get(0).getSchool() != null)
					retVal.add(list.get(0).getSchool());
				else
					retVal.add("");
				
				if(list.get(0).getProfileVisibility() != null)
					retVal.add(list.get(0).getProfileVisibility());
				else
					retVal.add("");
				return retVal;
			}
