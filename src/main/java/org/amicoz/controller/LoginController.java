...
public class LoginController {
	...
	public String validate(@ModelAttribute("LoginInfo") LoginInfo loginInfo, ModelMap modelMap) throws IOException {
	...
	public String logout(ModelMap modelMap) {
		modelMap.addAttribute("s_userid", "");
		modelMap.addAttribute("s_emailid", "");
		modelMap.addAttribute("s_imgsrc", "");
		modelMap.addAttribute("s_groupid", "");
		modelMap.addAttribute("s_fullname", "");
		return "../login_amicoz";
	}
